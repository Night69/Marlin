...
#define STRING_CONFIG_H_AUTHOR "(Tomas P, Ender-5)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 797.6, 144 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET {-40, -14, -1.92 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 37       // Number of LEDs in the strip, larger of 2 strips if 2 neopixel strips are used
